...
app.include_router(club_classes.router, prefix="/api/v1/admin/club", tags=["club-classes"])
app.include_router(class_analytics.router, prefix="/api/v1/admin/club", tags=["class-analytics"])
